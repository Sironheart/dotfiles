...
- Most projects will use [mise](https://mise.jdx.dev) to install software that is missing in the environment
- Only write to files. Docker/Kubernetes/Kafka/Database/etc services should only be used to read from, never write to!
- All changes require human review! Don't ever just commit, apply or edit without a human first approving this changes
